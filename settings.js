...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=W35yTCCA#yT8tzCX8TwhpB_iVo9GGEpzW_XQcLxV0qjgmWN63aIE' : process.env.SESSION_ID,
...
SEEDER_GMAIL: process.env.SEEDER_GMAIL === undefined ? "rithikbinsara20gamil
com" : process.env.SEEDER_GMAIL,
SEEDER_PASSWORD: process.env.SEEDER_PASSWORD === undefined ? "@rithik123" : process.env.SEEDER_PASSWORD,
