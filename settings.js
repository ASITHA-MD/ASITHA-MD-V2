...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=23xCkRjb#RypdOgi3ZDoMEG_SK_a44XLKfOMuQEozI6vgGyKg4Rw' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || ',' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , I am alive now!!*" : process.env.ALIVE_MSG,
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS === undefined ?"true" : process.env.AUTO_READ_STATUS,
MODE: process.env.MODE === undefined ?"public" : process.env.MODE,
AUTO_VOICE: process.env.AUTO_VOICE === undefined ? "true e" : process.env.AUTO_VOICE,
...
AUTO_REACT: process.env.AUTO_REACT === undefined ? "true e" : process.env.AUTO_REACT,
